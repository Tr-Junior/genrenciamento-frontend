...
export class SalesPageComponent implements OnInit {
  ...
  savePercentages() {
    localStorage.setItem('creditPercentage', this.creditPercentage.toString());
    localStorage.setItem('debitPercentage', this.debitPercentage.toString());
    this.toastr.success('Taxas salvas com sucesso!', 'Sucesso');
  }
...
//     // Adiciona os totais individuais por forma de pagamento com desconto das porcentagens
//     Array.from(paymentTotalsMap).forEach(([paymentMethod, total]) => {
//       let discountedTotal = total;
//       if (paymentMethod === 'Crédito') {
//         discountedTotal = total - (total * (this.creditPercentage / 100));
//       } else if (paymentMethod === 'Débito') {
//         discountedTotal = total - (total * (this.debitPercentage / 100));
//       }
//       this.paymentTotals.push({ paymentMethod, total: discountedTotal, className: paymentClasses[paymentMethod] || 'payment-others' });
//     });

//     // Adiciona a soma total de todas as vendas com a classe 'total'
//     const totalSalesWithDiscount = totalSales - (totalSales * ((this.creditPercentage + this.debitPercentage) / 200)); // Ajuste conforme necessário
//     this.paymentTotals.push({ paymentMethod: 'Total', total: totalSalesWithDiscount, className: paymentClasses['Total'] });
